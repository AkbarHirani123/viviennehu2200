	...
	public function index() {
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('payment/alipay_cross_border', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);

		$data['action'] = HTTPS_SERVER . 'index.php?route=payment/alipay_cross_border&token=' . $this->session->data['token'];
		...
		$this->response->setOutput($this->load->view('payment/alipay_cross_border.tpl', $data));
	}

	// validate form data
	private function validate() {
		if (!$this->user->hasPermission('modify', 'payment/alipay_cross_border')) {
