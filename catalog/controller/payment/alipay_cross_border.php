...
class ControllerPaymentAlipayCrossBorder extends Controller {
    private $order_id_prefix = 'TEST2-';
    public function index() {
        // variable $alipay_config is defined in this file
        require_once(DIR_SYSTEM . "library/alipay/cross_border/alipay.config.php");
        $this->language->load('payment/alipay_cross_border');
        ...
        $return_url = HTTPS_SERVER . 'index.php?route=payment/alipay_cross_border/return_url';
        $notify_url = HTTPS_SERVER . 'index.php?route=payment/alipay_cross_border/notify';
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/alipay_cross_border.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/payment/alipay_cross_border.tpl';
        } else {
            $this->template = 'default/template/payment/alipay_cross_border.tpl';
        }
    ...
    public function rendMessage($message) {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/alipay_cross_border_return.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/payment/alipay_cross_border_return.tpl';
        } else {
            $this->template = 'default/template/payment/alipay_cross_border_return.tpl';
        }
